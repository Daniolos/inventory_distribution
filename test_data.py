...
scenarios = [
    ...
    # B3: Product with 5 sizes, store has 0 → all 5 should transfer
    {
        "name": "B3a: MinSize 5 sizes - Size XS",
        "description": "5 sizes available, store has 0 → all 5 transfer",
        ...
        **all_stores_zero(),
        "Сток": 1,
        "Фото склад": 0,
        "expected_script1": "All 5 sizes to 125007",
        "expected_script2": "No change",
    },
    {
